...
public interface CarDao {
    ...
    @SqlUpdate("INSERT INTO cars (license_plate, brand, carmodel, dateregistration, price, image) VALUES (?, ?, ?, ?, ?, ?)")
    int addCar(String license_plate, String brand, String carmodel, int dateregistration, float price, String image);
